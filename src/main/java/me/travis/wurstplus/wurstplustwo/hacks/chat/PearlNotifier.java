        ...
        if (mc.world != null && mc.player != null) {
            ...
            if (this.enderPearl == null) {
                ...
                if (closestPlayer != null && this.flag) {
                    ...
                    WurstplusMessageUtil.send_client_message(ChatFormatting.GREEN + "PearlNotifier" + ChatFormatting.DARK_AQUA + "> " + ChatFormatting.RED + closestPlayer.getName() + ChatFormatting.WHITE + " thrown a pearl heading " + faceing);
                    this.flag = false;
                }
